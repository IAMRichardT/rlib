...
*/
    ...
    _f( pref( 'rcfg_item_name' ),                   { size = 15, weight = 100, antialias = true, font = 'Roboto Lt' } )
    _f( pref( 'rcfg_item_ver' ),                    { size = 13, weight = 500, antialias = true, font = 'Roboto Lt' } )
    _f( pref( 'rcfg_item_rel' ),                    { size = 14, weight = 100, antialias = true, font = 'Segoe UI Light' } )
    _f( pref( 'rcfg_item_desc' ),                   { size = 13, weight = 100, antialias = true, font = 'Roboto Lt' } )
