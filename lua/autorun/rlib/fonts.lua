...
*/
    ...
    _f( pref( 'rcfg_lst_name' ),                    { size = 18, weight = 100, antialias = true, font = 'Roboto Lt' } )
    _f( pref( 'rcfg_lst_ver' ),                     { size = 14, weight = 500, antialias = true, font = 'Roboto Lt' } )
    _f( pref( 'rcfg_lst_rel' ),                     { size = 19, weight = 100, antialias = true, font = 'Segoe UI Light' } )
