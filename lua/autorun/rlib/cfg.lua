    ...
    */
        ...
        [ 'help' ] =
        {
            ...
            func = function( )
                ...
                konsole:send( 0, Color( 31, 133, 222 ), 'Help  •  Commands' )
    ...
    */
        ...
        [ 'debug' ] =
        {
            ...
            func = function( self, args )
                local switch        = args and args[ 1 ] or 'on'
                switch              = helper.util:humanbool( switch, true )
                local dur           = args and args[ 2 ] or 300
                dur                 = tostring( dur )

                net.Start           ( 'rlib.debug'      )
                net.WriteString     ( switch            )
                net.WriteString     ( dur               )
                net.SendToServer    (                   )

                konsole:send_varg( 0, 'Debugging now %s', switch )
            end
        },

    /*
    *   konsole > command > clear
    */
    ...
    /*
    *   konsole > command > triggers
    */

        [ 'triggers' ] =
        {
            desc = 'list of konsole triggers',
            func = function( )
                konsole:send( 0, Color( 31, 133, 222 ), 'Help  •  Triggers' )
                konsole:send_varg( 0, '  %s          %s', '!', 'Send to chat' )
                konsole:send_varg( 0, '  %s         %s', '#', 'Execute Concommand' )
                konsole:send( 0, '' )
            end
        },

    /*
    *   konsole > command > history
    */
        ...
        [ 'history' ] =
        {
            ...
            func = function( )
                ...
                konsole:send( 0, Color( 31, 133, 222 ), 'History' )
                konsole:send_varg( 0, '%i entries in command history', i_history )
                konsole:send( 0, '' )
            end
        },

    /*
    *   konsole > command > clearhistory
    */
        ...
        [ 'clearhistory' ] =
        {
            ...
            func = function( )
                ...
                konsole:send( 0, Color( 31, 133, 222 ), 'Clear History' )
                konsole:send_varg( 0, '%i entries successfully cleared', i_history )
                konsole:send( 0, '' )
            end
        },

    /*
    *   konsole > command > listhistory
    */
        ...
        [ 'listhistory' ] =
        {
            ...
            func = function( )
                ...
                konsole:send( 0, 'History List' )
                konsole:send( 0, h_list )
            end
        },

    /*
    *   konsole > command > uptime
    */
        ...
        [ 'uptime' ] =
        {
            ...
            func = function( )
                ...
                konsole:send( 0, Color( 31, 133, 222 ), 'Uptime' )
                konsole:send( 0, uptime )
                konsole:send( 0, '' )
            end
        },

    /*
    *   konsole > command > version
    */
    ...
    */
        ...
        [ 'fps' ] =
        {
            ...
            func = function( )
                ...
                konsole:send( 0, Color( 31, 133, 222 ), 'FPS' )
                konsole:send( 0, tostring( fps ) )
                konsole:send( 0, '' )
            end
        },

    /*
    *   konsole > command > exit
    */
